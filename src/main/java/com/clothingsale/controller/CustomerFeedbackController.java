...
@WebServlet(
        ...
        urlPatterns = {"/customer/feedback", "/feedback/add", "/feedback/create"}
)
public class CustomerFeedbackController extends HttpServlet {
    ...
    private void createFeedback(
        ...
        try {
            ...
            java.util.List<OrderDetail> eligibleDetails = feedbackService.getEligibleOrderDetailsForFeedback(userId, productId);
