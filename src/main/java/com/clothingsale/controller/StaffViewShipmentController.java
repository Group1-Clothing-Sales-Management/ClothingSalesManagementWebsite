...
public class StaffViewShipmentController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("confirmForm".equalsIgnoreCase(action)) {
            ...
            request.getRequestDispatcher("/view/staff/staff_confirm_shipment.jsp").forward(request, response);
        } else {
            ...
            request.getRequestDispatcher("/view/staff/staff_view_shipment.jsp").forward(request, response);
        }
    }
