                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-5 border-b border-gray-100 flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-4 bg-gray-50/50">
                        <div class="relative">
                            ...
                            <input type="text" id="searchInput" onkeyup="filterProducts()" placeholder="Tìm tên sản phẩm, mã SKU..." class="pl-9 pr-4 py-2 border border-gray-200 rounded-lg text-sm w-full sm:w-80 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all bg-white">
                        </div>
                    </div>
                        ...
                        <table class="w-full text-left border-collapse">
                            <thead>
                                <tr class="border-b border-gray-200 bg-gray-50 text-xs font-bold uppercase tracking-wider text-gray-500 select-none">
                                    <th class="py-4 px-6">Sản phẩm & Thương hiệu</th>
                                    <th class="py-4 px-6">Mã SKU</th>
                                    <th class="py-4 px-6 text-right">Giá vốn</th>
                                    <th class="py-4 px-6 text-right">Giá bán hiện tại</th>
                                    ...
                                    <tr>
                                        <td colspan="7" class="text-center py-16 text-gray-400 bg-gray-50/50">
                                            <div class="flex flex-col items-center justify-center gap-2">
                                                ...
                                                <span class="font-medium text-base text-gray-500">Danh sách sản phẩm trống</span>
                                                <p class="text-xs text-gray-400 max-w-xs">Hệ thống hiện tại chưa ghi nhận dữ liệu mặt hàng nào khả dụng.</p>
                                            </div>
                                        </td>
                                    </tr>
                                <% 
