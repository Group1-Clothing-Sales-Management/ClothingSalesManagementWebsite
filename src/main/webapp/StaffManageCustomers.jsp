...
<head>
    ...
    <style>
        ...
        /* Sidebar width kept by sidebar.jsp itself */
        .content-area {
            flex: 1;
            padding: 28px 32px;
            min-width: 0;
    ...
    <div class="content-area">
        ...
        <c:if test="${empty pageMode or pageMode eq 'list'}">
            ...
            <div class="page-header">
                <h1 class="page-title"><i class="bi bi-people-fill"></i>Quản lý Khách hàng</h1>
                    ...
                    <c:choose>
                        <c:when test="${empty customers}">
                            <div class="empty-state">
                                ...
                                <p class="mb-0 fw-semibold">Không tìm thấy khách hàng nào</p>
                                <p class="text-muted small mt-1">
                                    <c:choose>
                                        <c:when test="${not empty keyword}">Thử tìm kiếm với từ khóa khác.</c:when>
                                                ...
                                                <td>
                                                    <c:choose>
                                                        <c:when test="${c.status eq 'ACTIVE'}">
                                                            <span class="badge badge-active px-2 py-1 rounded-pill">Hoạt động</span>
                                                        </c:when>
                                                        <c:when test="${c.status eq 'INACTIVE'}">
                                                            <span class="badge badge-inactive px-2 py-1 rounded-pill">Không hoạt động</span>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <span class="badge badge-locked px-2 py-1 rounded-pill">Bị khóa</span>
                                                        </c:otherwise>
                                                    </c:choose>
                                                </td>
                                                <td>
        ...
        <c:if test="${pageMode eq 'add'}">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/staff/dashboard">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/staff/customers">Quản lý Khách hàng</a></li>
                    <li class="breadcrumb-item active">Thêm mới</li>
                </ol>
            </nav>

            <div class="page-header">
                <h1 class="page-title"><i class="bi bi-person-plus-fill"></i>Thêm khách hàng mới</h1>
                <a href="${pageContext.request.contextPath}/staff/customers"
            ...
            <div class="card card-main">
                <div class="card-body p-4">
                    <form method="post" action="${pageContext.request.contextPath}/staff/customers"
                        ...
                        <p class="form-section-title"><i class="bi bi-person-vcard me-1"></i>Thông tin tài khoản</p>
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="username"
                                       ...
                                       value="${formData.username}" placeholder="vd: nguyenvana"/>
                        ...
                        <p class="form-section-title"><i class="bi bi-info-circle me-1"></i>Thông tin cá nhân</p>
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="fullName"
                                       ...
                                       value="${formData.fullName}" placeholder="Nguyễn Văn A"/>
        ...
        <c:if test="${pageMode eq 'edit'}">
            ...
            <div class="page-header">
                <h1 class="page-title"><i class="bi bi-pencil-square"></i>Chỉnh sửa khách hàng</h1>
                <a href="${pageContext.request.contextPath}/staff/customers"
                   class="btn btn-outline-secondary btn-sm px-3">
                    <i class="bi bi-arrow-left me-1"></i>Quay lại
                </a>
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="status"
                                    ...
                                    <option value="ACTIVE"   ${customer.status eq 'ACTIVE'   ? 'selected' : ''}>Hoạt động</option>
                                    <option value="INACTIVE" ${customer.status eq 'INACTIVE' ? 'selected' : ''}>Không hoạt động</option>
                                    <option value="LOCKED"   ${customer.status eq 'LOCKED'   ? 'selected' : ''}>Bị khóa</option>
                                </select>
