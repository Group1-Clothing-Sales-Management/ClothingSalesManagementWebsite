    ...
    <c:choose>
        ...
        <c:otherwise>
            ...
            <section class="detail-hero">
                ...
                <div class="detail-hero__amount"><span class="detail-hero__amount-label">Estimated refund</span><strong><fmt:formatNumber value="${returnRequest.refundAmount}" pattern="#,##0"/> ₫</strong><small><i class="fa-solid fa-shield-heart me-1"></i>Processed securely</small></div>
            </section>
