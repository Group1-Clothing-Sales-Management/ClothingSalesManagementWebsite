                        ...
                        <form action="${pageContext.request.contextPath}/admin/voucher" method="POST" id="editVoucherForm">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="form-group col-md-4" id="maxDiscountGroup">
                                    <label for="maxDiscountAmount" class="font-weight-bold">Max Discount Limit (đ)</label>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <small class="text-info font-weight-bold">Usage progress: ${voucher.usedCount} consumed.</small>
                                </div>
                            ...
                            <div class="d-flex justify-content-end">
                                <c:if test="${!isExpired}">
                                    <button type="submit" class="btn btn-primary font-weight-bold px-5">
                                        <i class="fas fa-save mr-2"></i> Update Configurations
                                    </button>
                                </c:if>
                            </div>
                        </form>
