        ...
        <script>
                                                    document.addEventListener("DOMContentLoaded", function () {
                                                        ...
                                                        function renderAdminMatrix() {
                                                            ...
                                                            let colors = colorInput.value.split(",")
                                                                    .map(c => c.trim())
                                                                    .filter(c => c.length > 0);
                    ...
                    <tr>
                        <td colspan="2" class="text-center py-4 text-muted">
                            <i class="fa-solid fa-circle-info me-1"></i>Please select sizes and type colors above to generate variants.
                                                            ...
                                                            colors.forEach(color => {
                                                                sizes.forEach(size => {
                                                                    ...
                                                                    htmlRows += "<tr>" +
                                                                            ...
                                                                            "name='variants[" + index + "].skuCode' value='" + suggestedSku + "' required>" +
                                                                            "</td>" +
                                                                            "</tr>";
                                                                    index++;
                                                                });
                                                    ...
                                                    // Hàm xóa sản phẩm chuẩn hóa bảo mật theo phương thức POST
                                                    function deleteProduct(id) {
                                                        Swal.fire({
                                                            ...
                                                            if (result.isConfirmed) {
                                                                // Gán ID vào form ẩn và tiến hành submit dạng POST lên Controller
